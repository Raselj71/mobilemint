...
export const apps: App[] = [
  ...
  },
  {
    ...
    screenshots: [
      "/apps/all-document-reader/screens/01-home.png",
      "/apps/all-document-reader/screens/02-excel.png",
      "/apps/all-document-reader/screens/03-ppt.png",
    ],
    version: "1.0.0",
    updated: "2026-07-02",
    ...
    privacy: {
      ...
      summary:
        "All Document Reader opens the files you choose directly on your device — we never upload them, and the app collects no personal data. It is free, with ads and optional in-app purchases, and does not share your data with third parties.",
      collectsPersonalData: false,
      accountRequired: false,
      showsAds: true,
      usesAnalytics: false,
      ...
      childDirected: false,
      dataPoints: [
        { type: "Files & storage access", purpose: "Used only to open and display the documents you choose. Files are read on your device and never uploaded." },
        { type: "Advertising ID", purpose: "Used by our ad partner to display ads. It is not linked to your identity or your files." },
      ],
      thirdParties: [
        { name: "Google AdMob", purpose: "Advertising", policyUrl: "https://support.google.com/admob/answer/6128543" },
      ],
  ...
  {
    slug: "japan-train-card-balance-check",
    ...
    privacy: {
      ...
      dataDeletion: {
        ...
        steps: [
          ...
          "Confirm. Every saved card, its nickname, and its stored journey history are removed from the phone straight away.",
